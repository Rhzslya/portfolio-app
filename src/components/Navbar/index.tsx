    ...
    >
      ...
      <nav className="w-[1400px]">
        <div className="container_navlink flex items-center justify-center">
          <div className="box_image mr-9 my-2">
            <Link
              href="/"
              as="/"
          ...
          >
            ...
            <div className="social_media_box mt-auto flex sm:hidden items-center justify-center gap-4 text-white text-[26px] mx-8 mb-8">
          ...
          <div className="box-resume relative flex justify-center items-center text-center mx-3">
